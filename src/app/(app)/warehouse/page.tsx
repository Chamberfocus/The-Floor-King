          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-muted-foreground">
            ...
            {j.staging_location ? (
              <span className="flex items-center gap-1.5">
                ...
                Staged at {j.staging_location}
              </span>
            ) : null}
          </div>
        </CardHeader>
        <details className="group border-t">
          <summary className="flex cursor-pointer list-none items-center gap-1.5 px-6 py-2.5 text-xs font-medium text-muted-foreground hover:text-foreground [&::-webkit-details-marker]:hidden">
            <ChevronDown className="size-4 transition-transform group-open:rotate-180" />
            Materials, prep &amp; delivery
          </summary>
