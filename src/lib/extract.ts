...
- "type": infer from the notes (broadloom→carpet, carpet tile / modular carpet→carpet and mention "carpet tile" in notes — not ceramic "tile", plank/LVP/LVT/SPC→lvp, engineered/solid/wood→hardwood, ceramic/porcelain→tile, sheet→vinyl).
