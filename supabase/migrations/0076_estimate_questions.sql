...
from (values
  ...
  ('Carpet','What padding?','Pulled from the catalog as a material, like the carpet.','product','{"category":"underlayment","ask_source":true}',false,30),
  ('Carpet','Additional padding — how many extra sq ft? (0 if none)',null,'number','{"emit":{"role":"material","category":"underlayment","description":"Additional padding","unit":"sqft","per":"each","cost":0}}',false,40),
